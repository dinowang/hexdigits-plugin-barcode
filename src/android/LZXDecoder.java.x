 ...
 * Date: 03/11/2014
 */
public class LZXDecoder //implements BarcodeDecoder
{
...
//
//    public LZXDecoder(String format)
//    {
...
//        }
//        else {
//          hints.put(DecodeHintType.POSSIBLE_FORMATS, EnumSet.of(BarcodeFormat.QR_CODE, BarcodeFormat.CODE_39));
//        }
//
...
//    }
//
//    public synchronized String decode(final byte[] image, final int width, final int height)
//    {
//        Result result = null;
//
