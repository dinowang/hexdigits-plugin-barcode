 ...
 */
public class LargeViewFinderView extends View implements IViewFinder {
    private static final String TAG = "LargeViewFinderView";
    ...
    public LargeViewFinderView(Context context) {
        super(context);
        init();
    }

    public LargeViewFinderView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
